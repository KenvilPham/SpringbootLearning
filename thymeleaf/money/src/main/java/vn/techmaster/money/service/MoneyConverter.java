...
public class MoneyConverter {
  ...
  public MoneyConverterResponse getConvertResponse(MoneyConvertRequest request) {
    int amount = request.getAmount();
    String fromCurrency = request.getFromCurrency();
    String toCurrency = request.getToCurrency();

    float resultConverMoney = (float) amount * getExchangeRate(toCurrency) / getExchangeRate(fromCurrency);
    return new MoneyConverterResponse(resultConverMoney, fromCurrency, toCurrency);
  }
